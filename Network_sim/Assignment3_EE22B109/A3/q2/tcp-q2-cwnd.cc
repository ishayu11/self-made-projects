...
int main(int argc, char* argv[])
{
  ...
  p2pBottleneck.EnablePcapAll("scratch/combined/ns3-projects/bottleneck_q2");
  AsciiTraceHelper asciiTraceHelper;

  // Trace Flow 1 (Node 0)
  Ptr<OutputStreamWrapper> stream1 = asciiTraceHelper.CreateFileStream("scratch/combined/ns3-projects/flow1.cwnd");
  Simulator::Schedule(Seconds(1.1), &TraceCwnd, "/NodeList/0/$ns3::TcpL4Protocol/SocketList/0/CongestionWindow", stream1);

  // Trace Flow 2 (Node 1)
  Ptr<OutputStreamWrapper> stream2 = asciiTraceHelper.CreateFileStream("scratch/combined/ns3-projects/flow2.cwnd");
