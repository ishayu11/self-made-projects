...
int main(int argc, char* argv[])
{
  ...
  p2pBottleneck.EnablePcapAll("scratch/combined/q1/bottleneck_q1");
  AsciiTraceHelper asciiTraceHelper;
  Ptr<OutputStreamWrapper> stream = asciiTraceHelper.CreateFileStream("scratch/combined/q1/q1_single.cwnd");
